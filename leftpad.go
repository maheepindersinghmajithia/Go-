...
//Format take in a string and an int and returns the string
...
// left_padded with the specified rune to the length of the length of the int. If the
// string is already longer than the specified length, the
// original string is returned.
